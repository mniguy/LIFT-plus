...
for data in ${DATASETS}; do
  ...
  run "${data}" shrink_lv3   PROMPT_CENTER_MODE cohesion \
                          PROMPT_CENTER_COHESION_LEVELS "${LV3}" \
                          PROMPT_CENTER_COHESION_W shrink PROMPT_CENTER_COHESION_RHO group
  run "${data}" shrink_lv6   PROMPT_CENTER_MODE cohesion \
                          PROMPT_CENTER_COHESION_LEVELS "${LV6}" \
                          PROMPT_CENTER_COHESION_W shrink PROMPT_CENTER_COHESION_RHO group
  run "${data}" cliff_group  PROMPT_CENTER_MODE cohesion PROMPT_CENTER_COHESION_LEVELS "${LEVEL}" \
                          PROMPT_CENTER_COHESION_W cliff PROMPT_CENTER_COHESION_RHO group
done
