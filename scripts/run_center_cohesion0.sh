...
for data in ${DATASETS}; do
  ...
  run "${data}" w_one   PROMPT_CENTER_MODE cohesion PROMPT_CENTER_COHESION_LEVELS "${LEVEL}" \
                          PROMPT_CENTER_COHESION_W one
  run "${data}" shrink_group PROMPT_CENTER_MODE cohesion PROMPT_CENTER_COHESION_LEVELS "${LEVEL}" \
                          PROMPT_CENTER_COHESION_W shrink PROMPT_CENTER_COHESION_RHO group
  run "${data}" shrink_level PROMPT_CENTER_MODE cohesion PROMPT_CENTER_COHESION_LEVELS "${LEVEL}" \
                          PROMPT_CENTER_COHESION_W shrink PROMPT_CENTER_COHESION_RHO level
done
